...
class FID: 
   ...
   def predict_result(self,fname):     
      ...
      model = load_model('D://projects//IFAKE//IFAKE_AI//ela_casia.h5')
   ...
   def genMask(self,file_path):
      ...
      #segmenter.load_weights('D://projects//IFAKE//IFAKE_AI//weights.h5')
      segmenter.load_weights('D://projects//IFAKE//IFAKE_AI//segmenter_weights.h5')
